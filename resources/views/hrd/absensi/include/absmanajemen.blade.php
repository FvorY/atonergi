        ...
        <div class="card-body">
          <h4 class="card-title">Absensi Manajemen</h4>
          	<div class="row alamraya-dwld-row">
          		<button type="button" class="btn btn-warning btn-rounded btn-fw alamraya-dwld-btn" onclick="javascipt:window.open('{{ url('') }}/public/assets/berkas/absensi-manajemen/contoh-master-manajemen.xlsx');"><i class="fa fa-download"></i>&nbsp;&nbsp;Download Contoh Master</button>&nbsp;&nbsp;
          		<button type="button" class="btn btn-warning btn-rounded btn-fw" onclick="javascipt:window.open('{{ url('') }}/public/assets/berkas/absensi-manajemen/id-manajemen.xlsx');"><i class="fa fa-download"></i>&nbsp;&nbsp;Download ID Manajemen</button>
          	</div><br>
          	<div class="row ">
            ...
            <div class="row form-group">
                		...
                		<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-12 alamraya-no-padding">
								<div id="datepicker-popup" class="input-group date datepicker">
			                        <input type="text" class="form-control" placeholder="dd-mm-yyyy" id='absmanajemen_tgl_awal'>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 alamraya-no-padding">
								<div id="datepicker-popup" class="input-group date datepicker">
			                        <input type="text" class="form-control" placeholder="dd-mm-yyyy" id='absmanajemen_tgl_akhir'>
			                        <div class="input-group-addon">
			                          <span class="mdi mdi-calendar"></span>
			                        </div>
			                    </div>
							...
							<div class="col-lg-3 col-md-3 col-sm-12 alamraya-no-padding alamraya-opt-btn">
								<span class="input-group-append">
									<button type="button" class="btn btn-primary btn-sm icon-btn ml-2" id="absmanajemen_search">
		                              <i class="fa fa-search"></i>
		                            </button>
		                             <button type="button" class="btn btn-info btn-sm icon-btn ml-2"  id='absmanajemen_refresh'>
				...
				<div class="col-lg-4 col-md-12 col-sm-12 ">
                	...
                	<div class="col-lg-12 col-md-12 col-sm-12 alamraya-no-padding">
						<div class="form-group">
							<select class="form-control form-control-sm" id="absmanajemen_id_divisi">
          	...
          	<div class="row ">
				...
				<div class="table-responsive">
					<table class="table table-hover" cellspacing="0" id="tbl_absmanajemen">
