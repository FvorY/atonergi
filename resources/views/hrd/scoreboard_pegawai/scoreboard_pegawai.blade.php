...
@include('hrd/scoreboard_pegawai/tambah_scoreboard_pegawai')
@include('hrd/scoreboard_pegawai/edit_scoreboard_pegawai')
<!-- partial -->
<div class="content-wrapper">
	<div class="row">
		<div class="col-lg-12">	
			<nav aria-label="breadcrumb" role="navigation">
				<ol class="breadcrumb bg-info">
					...
					<li class="breadcrumb-item active" aria-current="page">Scoreboard Pegawai Per Hari</li>
				</ol>
			</nav>
		</div>
		<div class="col-lg-12 grid-margin stretch-card">
	      	<div class="card">
		        <div class="card-body">
		          <h4 class="card-title">Scoreboard Pegawai Per Hari</h4>
