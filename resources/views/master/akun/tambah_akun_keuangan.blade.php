                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                  <div class="form-group form-group-sm">
                    <div class="input-group">
                      <span class="input-group-addon bg-default border-default" style="width: 50px"><input style="border:transparent !important" type="text"size="2" name="kelompok_akun" readonly="" id="kelompok_akun"></span>
