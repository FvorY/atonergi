                ...
                <div class="col-md-12" style="margin-top: 20px;">
                    <div class="row">
                        <div class="col-md-6 content-title">
                            Tambah Data Transaksi Memorial
                        </div>
                                    ...
                                    <table class="table table-stripped table-bordered table-mini">
                                        <tr>
                                            ...
                                            <td width="22%" style="background: #fff;">
                                                 <vue-inputmask :id="'totalDebet'" :css="'border: 0px; background: white; font-size: 9pt; height: 20px; padding-right: 0px;'" :readonly="true"></vue-inputmask>
                                            </td>

                                            <td width="22%" style="background: #fff;">
                                                <vue-inputmask :id="'totalKredit'" :css="'border: 0px; background: white; font-size: 9pt; height: 20px; padding-right: 0px;'" :readonly="true"></vue-inputmask>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
