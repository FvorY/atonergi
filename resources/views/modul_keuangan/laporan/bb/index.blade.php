...
<html>
	<head>
		...
		<title>Laporan Bukti Bank Keluar</title>
				          ...
				          <thead>
				            <tr>
				            	...
				            	<td width="30%" rowspan="2" style="font-size: 12pt; font-weight: bold; text-align: center;">
				            		{{ ($_GET['type'] == 'bkk') ? 'Bukti Bank Keluar' : 'Bukti Bank Masuk' }}
				            	</td>
						...
						<table width="100%" class="table-data" border="0" style="font-size: 9pt; margin-top: 10px">
				          <thead>
				            <tr>
				            	...
				            	<td width="15%" style="background: #4B515D; color: white; border-right: 1px solid white; text-align: center; font-size: 8pt;"> Bankir </td>
	        ...
	        <div class="ez-popup" id="setting-popup">
	            <div class="layout" style="width: 35%; min-height: 150px;">
	                ...
	                <div class="content-popup">
	                	<form id="form-setting" method="get" action="{{ route('laporan.keuangan.bb') }}">
	                	<input type="hidden" readonly name="_token" value="{{ csrf_token() }}">
	                    <div class="col-md-12">

	                    	<div class="row mt-form">
	                            <div class="col-md-4">
	                                <label class="modul-keuangan">Type Bukti Bank</label>
	                            </div>

	                            <div class="col-md-7">
	                            	<select name="type" id="type" class="form-control" style="font-size: 9pt">
	                            		<option value="bbk">Bukti Bank Keluar</option>
	                            		<option value="bbm">Bukti Bank Masuk</option>
	                            	</select>
	                            </div>
