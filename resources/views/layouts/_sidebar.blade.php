      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav" id="ayaysir">
            ...
            @if ( (int)$sidebar[37]->aktif == 1 || (int)$sidebar[38]->aktif == 1 || (int)$sidebar[39]->aktif == 1 || (int)$sidebar[40]->aktif == 1 || (int)$sidebar[41]->aktif == 1)
