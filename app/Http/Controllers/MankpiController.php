    ...
    public function getKpiByTgl($tgl1, $tgl2, $tampil)
    {
        ...
        if ($tampil == 'ALL') {
            $data = d_kpi::join('m_pegawai','d_kpi.d_kpi_pid','=','m_pegawai.mp_id')
                        ->join('m_jabatan', 'c_id', '=', 'mp_position')
            ...
            if ($data->d_kpi_isconfirm == 'Y') {
                return '<div class="text-center">
                            ...
                            <button class="btn btn-sm btn-danger" title="Batalkan Konfirmasi"
                                onclick=ubahStatus("'.$data->d_kpi_id.'","Y")><i class="fa fa-forward"></i>
                            </button>
                        </div>';
            }else{
                return '<div class="text-center">
                            ...
                            <button class="btn btn-sm btn-default" title="Konfirmasi"
                                onclick=ubahStatus("'.$data->d_kpi_id.'","N") disabled><i class="fa fa-backward"></i>
                            </button>
                        </div>';
            }
        })
