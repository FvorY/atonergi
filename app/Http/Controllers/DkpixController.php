...
use Carbon\Carbon;
use App\Model\d_kpix;
use App\Model\d_kpix_dt;
...
class DkpixController extends Controller
{
    ...
    public function tambahData()
    {
        ...
        $data = DB::table('m_pegawai')
            ...
            ->join('m_divisi', 'm_jabatan.c_divisi_id', '=', 'm_divisi.c_id')
            ->select('m_jabatan.c_divisi_id', 'm_divisi.c_divisi')
    ...
    public function lookupPegawai(Request $request)
    {
        ...
        if (empty($term))
        {
            $pegawai = DB::table('m_pegawai')->join('m_jabatan', 'm_jabatan.c_id', '=', 'mp_position')->where('c_divisi_id', $idDiv)->where('mp_position', $idJabatan)->get();
        ...
        {
            $pegawai = DB::table('m_pegawai')->join('m_jabatan', 'm_jabatan.c_id', '=', 'mp_position')->where('c_divisi_id', $idDiv)->where('mp_position', $idJabatan)->where('mp_name', 'LIKE', '%'.$term.'%')->get();
            foreach ($pegawai as $val) {
    ...
    public function getDataEdit($id)
    {
        ...
        $pegawai = d_kpix::join('m_pegawai', 'd_kpix.d_kpix_pid', '=', 'm_pegawai.mp_id')
            ->join('m_jabatan', 'm_pegawai.mp_position', '=', 'm_jabatan.c_id')
