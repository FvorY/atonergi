...
class ManscorekpiController extends Controller
{
            ...
            if ($data->d_kpix_isconfirm == 'Y') {
                return '<div class="text-center">
                            ...
                            <button class="btn btn-sm btn-danger" title="Batalkan Konfirmasi"
                                onclick=ubahStatus("'.$data->d_kpix_id.'","Y")><i class="fa fa-forward"></i>
                            </button>
                        </div>';
            }else{
                return '<div class="text-center">
                            ...
                            <button class="btn btn-sm btn-default" title="Konfirmasi"
                                onclick=ubahStatus("'.$data->d_kpix_id.'","N") disabled><i class="fa fa-backward"></i>
                            </button>
                        </div>';
            }
        })
    ...
    public function setFieldModal()
    {
        ...
        $data = DB::table('m_pegawai')
            ...
            ->select(
              ...
              'm_divisi.c_divisi',
              'm_jabatan.c_posisi')
            ->where('m_pegawai.c_id', '=', $id_peg)->first();
    ...
    public function getScoreByTgl($tgl1, $tgl2, $tampil)
    {
        ...
        if ($tampil == 'ALL') {
            $data = d_kpi::join('m_pegawai','d_kpi.d_kpi_pid','=','m_pegawai.mp_id')
